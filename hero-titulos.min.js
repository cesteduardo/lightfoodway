...
const destaques = [
{
linhas: ['Comida de verdade', 'para deixar sua', 'rotina '],
enfase: 'mais leve',
...
const partes = [];
destaque.linhas.forEach((texto, i) => {
const ultima = i === destaque.linhas.length - 1;
if (i) partes.push(document.createTextNode(' '));
partes.push(mascara(texto, ultima ? destaque.enfase : ''));
});
